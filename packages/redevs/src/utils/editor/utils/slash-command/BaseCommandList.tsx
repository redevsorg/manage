  ...
  return items.length > 0 ? (
    <div id="outstatic">
      <div
        ...
        className="z-50 h-auto max-h-[330px] w-72 overflow-y-auto rounded-md border-2 border-stone-200 invert bg-white px-1 py-2 transition-all"
      >
