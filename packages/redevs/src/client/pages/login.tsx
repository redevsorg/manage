        ...
        <main className="relative flex h-screen items-center bg-black justify-center z-10 p-4">
          <div className="relative flex flex-col items-center justify-center">
            ...
            <div className="text-center mb-20 flex max-w-2xl flex-col items-center p-8 px-4 md:p-8 text-white bg-black rounded-lg border-2 border-neutral-800 shadow-md">
              ...
              <a
                href="/api/redevs/login"
                onClick={() => setIsLoading(true)}
                className={clsx(
                  'mr-2 mb-2 inline-flex items-center rounded-lg bg-neutral-800 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-neutral-800/90 focus:outline-none focus:ring-4 focus:ring-[#24292F]/50',
